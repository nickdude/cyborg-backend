...
const QUESTIONARY_DATA = [
    ...
    "questions": [
      {
        ...
        "description": "Your health isn’t one-size-fits-all. Understanding your story helps us provide the best care tailored to you. Complete the survey in one go for the best experience - it takes about 15 minutes.",
        "type": "intro"
      },
      {
        "code": "1.2",
      ...
      {
        "code": "1.3",
        "title": "What biological sex were you assigned at birth?",
        "type": "single",
        "options": [
          "Male",
          "Female"
      ...
      },
      {
        ...
        "subtitle": "This information helps us better understand health patterns across different communities and provide more personalized care.",
        "type": "multi",
        "options": [
      ...
      {
        "code": "1.6",
        "title": "What is your height (ft/in)?",
        "type": "height"
      },
      {
        "code": "1.7",
    ...
    "questions": [
      {
        ...
        "description": "Let’s take a look at how you eat, move and sleep so we can craft the most effective plan for you.",
        "type": "intro"
      },
      {
        "code": "2.2",
    ...
    "questions": [
      {
        ...
        "description": "Tell us about any diagnoses, symptoms and medications you use. Any details are helpful so we can make effective recommendations. The more we know, the better we can support you.",
        "type": "intro"
      },
      {
        "code": "3.2",
      ...
      {
        "code": "3.8",
        "title": "Please list any vitamins and / or supplements you are currently taking.",
        "type": "textarea"
      },
      {
        "code": "3.9",
        "title": "Please list any surgeries you’ve had, including the year it was performed.",
        "type": "textarea"
      },
      {
        "code": "3.10",
        "title": "Do you have any significant health conditions that run in your family? This will help us personalize proactive recommendations & insights to help mitigate risk.",
        "subtitle": "Select all that apply.",
        "type": "multi",
        "options": [
      ...
      {
        "code": "3.12",
        "title": "Please add any details you want us to know (for example: “family history of breast cancer” or “my dad has high blood pressure”). Try to include as much detail as possible.",
        "type": "textarea"
      },
      {
        "code": "3.13",
        "title": "Is there anything about your medical history you want to add or that we didn’t cover?",
        "type": "textarea",
        "placeholder": "Tell us here..."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        "code": "4.1",
        "title": "Are you interested in discussing any of the following RX (prescription) treatments with your Superpower clinical team?",
        "subtitle": "Note: You will not be charged for any services by selecting any of the options below. It will only notify your clinician of your interest in the service.",
        "type": "multi",
        "options": [
    ...
    "questions": [
      {
        ...
        "description": "It’s time to get clear on what truly drives you. Think of this as your “why.” The more we understand your motivations and challenges, the better health guidance you’ll achieve.",
        "type": "intro"
      },
      {
        "code": "5.2",
      ...
      {
        "code": "5.6",
        "title": "We craft your results in language you can understand. How technical would you like your results presented to you?",
        "type": "scale",
        "options": [
          "1",
          "2",

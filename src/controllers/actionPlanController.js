    ...
    res.sendSuccess(
      {
        ...
        clinicalThesis: isPendingReview ? null : plan.clinicalThesis,
        checkpoints: isPendingReview ? null : plan.checkpoints,
        watchOuts: isPendingReview ? null : plan.watchOuts,
        dailySchedule: isPendingReview ? null : plan.dailySchedule,
        trainingProtocol: isPendingReview ? null : plan.trainingProtocol,
